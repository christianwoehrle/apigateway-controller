...
import (
	...
	"github.com/christianwoehrle/apigateway-controller/pkg/client/clientset/versioned"
	"github.com/christianwoehrle/apigateway-controller/pkg/inject"
...
func TestBee(t *testing.T) {
	...
	RunSpecsWithDefaultAndCustomReporters(t, "ApiGateway Suite", []Reporter{test.NewlineReporter{}})
}
...
var _ = BeforeSuite(func() {
	...
	defer GinkgoRecover()
	Eventually(func() interface{} { return arguments.ControllerManager.GetController("ApiGatewayController") }).
		Should(Not(BeNil()))
	ctrl = arguments.ControllerManager.GetController("ApiGatewayController")
})
