...
import (
	...
	. "github.com/christianwoehrle/apigateway-controller/pkg/apis/apigateway/v1beta1"
	. "github.com/christianwoehrle/apigateway-controller/pkg/client/clientset/versioned/typed/apigateway/v1beta1"
)

// EDIT THIS FILE!
// Created by "kubebuilder create resource" for you to implement the ApiGateway resource tests

var _ = Describe("ApiGateway", func() {
	var instance ApiGateway
	var expected ApiGateway
	var client ApiGatewayInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.ApigatewayV1beta1().ApiGateways("default")
